...
@section('content')
    <main class="h-dvh overflow-hidden bg-[#F7F6F3] text-[#111111] dark:bg-gray-950 dark:text-white">
        <div class="mx-auto flex h-full w-full max-w-6xl flex-col px-5 py-4 sm:px-8 lg:px-10">
            ...
            <section class="flex min-h-0 flex-1 items-center justify-center py-4">
                <div class="grid w-full items-center gap-8 lg:grid-cols-[0.9fr_1fr]">
                    <div class="hidden max-w-md lg:block">
                        <p class="mb-3 text-xs font-semibold uppercase tracking-[0.18em] text-gray-500 dark:text-gray-400">
                            Workspace baru
                        </p>
                        <h1 class="text-4xl font-semibold leading-[1.05] tracking-tight text-gray-950 dark:text-white">
                    ...
                    <div class="mx-auto w-full max-w-[460px] rounded-xl border border-[#EAEAEA] bg-white p-5 dark:border-white/10 dark:bg-white/[0.03] sm:p-6">
                        <div class="mb-5">
                            <p class="mb-2 text-xs font-semibold uppercase tracking-[0.16em] text-gray-500 dark:text-gray-400">
                                Daftar
                            </p>
                        ...
                        <form method="POST" action="{{ route('register.store') }}" class="space-y-4">
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="h-10 w-full rounded-md border border-gray-200 bg-white px-3.5 text-sm text-gray-900 outline-none transition placeholder:text-gray-400 focus:border-gray-900 dark:border-white/10 dark:bg-transparent dark:text-white dark:focus:border-white"
                                    />
                                    @error('company_name')
                            ...
                            <button class="flex h-10 w-full items-center justify-center rounded-md bg-[#111111] px-4 text-sm font-semibold text-white transition hover:bg-[#333333] active:scale-[0.99] dark:bg-white dark:text-gray-950 dark:hover:bg-gray-200">
                                Buat akun
                            </button>
                        </form>
                        ...
                        <div class="mt-4 border-t border-[#EAEAEA] pt-3 text-center text-xs leading-5 text-gray-400 dark:border-white/10 dark:text-gray-500">
