<div class="relative" x-data="{
    ...
    <div
        ...
        class="absolute right-0 z-50 mt-3 flex w-[240px] flex-col rounded-xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
        style="display: none;"
    >
        <!-- User Info -->
        <div>
            <span class="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">{{ auth()->user()?->name ?? 'User' }}</span>
            <span class="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">{{ auth()->user()?->email ?? 'user@paperwork.local' }}</span>
        </div>
        ...
        <form method="POST" action="{{ route('logout') }}">
            ...
            <a
                ...
                @click.prevent="closeDropdown(); $el.closest('form').submit();"
            >
                <span class="text-gray-500 group-hover:text-gray-700 dark:group-hover:text-gray-300">
